...
type
  ...
  public
    ...
    class function CreateSuccess(const ASuccess: S): TResultPair<S, F>; static; inline;
    ...
    class function CreateFailure(const AFailure: F): TResultPair<S, F>; static; inline;

    /// <summary>
    /// Sets the current TResultPair to the success state with the provided value.
    /// </summary>
    /// <param name="ASuccess">The success value to set.</param>
    procedure Success(const ASuccess: S); inline;

    /// <summary>
    /// Sets the current TResultPair to the failure state with the provided value.
    /// </summary>
    /// <param name="AFailure">The failure value to set.</param>
    procedure Failure(const AFailure: F); inline;
...
class function TResultPair<S, F>.CreateFailure(const AFailure: F): TResultPair<S, F>;
begin
...
class function TResultPair<S, F>.CreateSuccess(const ASuccess: S): TResultPair<S, F>;
begin
