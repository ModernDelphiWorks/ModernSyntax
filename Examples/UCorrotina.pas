...
begin
  if not Assigned(FScheduler) then
    Exit;
  FScheduler.Resume(FCoroutine_0);
end;
...
begin
  ...
  FScheduler.Started(procedure
                     begin
                       Memo3.Lines.Add('Iniciado...');
                     end)
            .Add(FCoroutine_0, Contador, 0, procedure
                              begin
                                LBL.Caption := '<=';
...
begin
  ...
  FScheduler.Started(procedure
            ...
            .Add(FCoroutine_0, Contador_Async, 0, procedure
                              begin
                                LBL.Caption := '<=';
                                Memo1.Lines.Add(FScheduler.Value.ToString);
                              end)
